...
* Keywords Search for Short Context
  ...
  * By rescaling the score in this method, we will be able to use method 1, 2, 3, 4 together: https://github.com/hanhanwu/Hanhan_NLP/blob/master/rescale_score.py
